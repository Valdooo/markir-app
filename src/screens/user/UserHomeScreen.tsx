...
export const UserHomeScreen = () => {
  ...
  const features = [
    { id: 1, icon: 'scan', label: 'Scan NFC', screen: 'NFCPayment', color: PRIMARY },
...
const styles = StyleSheet.create({
  ...
  featureCard: {
    ...
    paddingHorizontal: 6,
    marginBottom: 20,
    cursor: 'pointer' as any, // Enable pointer cursor on web
  },
  iconContainer: {
    width: 64,
    height: 64,
    ...
    justifyContent: 'center',
    marginBottom: 8,
    pointerEvents: 'none' as any, // Let TouchableOpacity handle clicks
  },
  featureLabel: {
    fontSize: 12,
    color: TEXT_DARK,
